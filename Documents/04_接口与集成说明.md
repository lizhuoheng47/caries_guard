...
- `GET /api/v1/rag/logs/fusion/{requestNo}`
- `GET /api/v1/rag/logs/rerank/{requestNo}`
- `GET /api/v1/rag/logs/llm/{requestNo}`
- `GET /api/v1/rag/eval/datasets`
- `GET /api/v1/rag/eval/datasets/{datasetId}`
- `GET /api/v1/rag/eval/runs`
- `GET /api/v1/rag/eval/runs/{runNo}`
- `GET /api/v1/rag/eval/runs/{runNo}/results`
...
- `GET /ai/v1/logs/requests`
- `GET /ai/v1/logs/requests/{requestNo}`
- `GET /ai/v1/logs/retrievals/{requestNo}`
- `GET /ai/v1/logs/graph/{requestNo}`
- `GET /ai/v1/logs/fusion/{requestNo}`
- `GET /ai/v1/logs/rerank/{requestNo}`
- `GET /ai/v1/logs/llm/{requestNo}`
- `GET /ai/v1/eval/datasets`
- `GET /ai/v1/eval/datasets/{datasetId}`
- `GET /ai/v1/eval/runs`
- `GET /ai/v1/eval/runs/{runNo}`
- `GET /ai/v1/eval/runs/{runNo}/results`
- `POST /ai/v1/eval/run`
